...
export default function FloatingWhatsApp() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-6 right-6 z-[100] flex items-center justify-center w-16 h-16 bg-[#25D366] text-white rounded-full shadow-2xl cursor-pointer hover:bg-[#20ba5a] transition-colors focus:outline-none focus:ring-4 focus:ring-green-500/50"
