...
export const orderSchema = z.object({
  customer: z.string()
    .min(10, "يرجى إدخال الاسم بالكامل (3 أسماء على الأقل)")
    .max(100, "الاسم طويل جداً"),
  phone: z.string()
    .regex(/^01[0125][0-9]{8}$/, "يرجى إدخال رقم موبايل مصري صحيح (11 رقم)"),
  address: z.string()
    .min(15, "يرجى إدخال العنوان بالتفصيل (الشارع، المنطقة، العلامة المميزة)")
